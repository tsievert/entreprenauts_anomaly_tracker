...
1. Double-click the project file (for example `AnomalyTracker.Rproj`) to open the folder in **RStudio**.
...
- **Search**
  ...
  - Enter coordinates by hand or click on the grid, then use **“Use suggested position”**.
